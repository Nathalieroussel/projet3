        ...
        <div class="header">
            <div class="bg-color">
                ...
                <span class="icon-bar"></span>
                                ...
                                <a class="navbar-brand" href="index.php?action=pageAccueil">Jean <span class="logo-dec">FORTEROCHE</span></a>
                            </div>
                            <div class="collapse navbar-collapse" id="myNavbar">
                                <ul class="nav navbar-nav navbar-right">
                                    <li class="active"><a href="index.php?action=pageAccueil#main-header">Home</a></li>
                                    <li class=""><a href="index.php?action=pageAccueil#apropos">A propos</a></li>

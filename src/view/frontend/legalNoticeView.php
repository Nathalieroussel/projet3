<?php $title = 'Jean Forteroche | Informations légales'; ?>
...
<div class="container">
	<section class="row">
		<div class="legalNotice">
			...
			<p>Ce site internet a était réalisé dans le cadre d'une formation avec des informations fictives. le site appartient à Nathalie ROUSSEL.</p>
			...
			<p><strong>Propriétaire</strong> : Jean Forteroche –  – 68 rue de la Liberté 24000 Périgueux<br />
			<strong>Créateur du site</strong>  : Nathalie ROUSSEL<br />
			<strong>Responsable publication</strong> : Jean Forteroche – 06-33-49-57-18<br />
			Le responsable publication est une personne physique ou une personne morale.<br />
			<strong>Webmaster</strong> : Nathalie Roussel – 24000 Périgueux<br />
			<strong>Hébergeur</strong> : 1 & 1<br/>
			</p>
			<hr/>
			...
			<p>Le site est mis à jour régulièrement par Valentin Perello. De la même façon, les mentions légales peuvent être modifiées à tout moment : elles s’imposent néanmoins à l’utilisateur qui est invité à s’y référer le plus souvent possible afin d’en prendre connaissance.</p>
			<hr/>
			...
			<p>Jean Forteroche ne pourra être tenue responsable des dommages directs et indirects causés au matériel de l’utilisateur, lors de l’accès au site jeanforteroche.com, et résultant soit de l’utilisation d’un matériel ne répondant pas aux spécifications indiquées au point 4, soit de l’apparition d’un bug ou d’une incompatibilité.</p>
			<p>Jean Forteroche ne pourra également être tenue responsable des dommages indirects (tels par exemple qu’une perte de marché ou perte d’une chance) consécutifs à l’utilisation du site.</p>
			...
			<p>Le site  contient un certain nombre de liens hypertextes vers d’autres sites, mis en place avec l’autorisation de Jean Forteroche. Cependant, Jean Forteroche n’a pas la possibilité de vérifier le contenu des sites ainsi visités, et n’assumera en conséquence aucune responsabilité de ce fait.</p>
